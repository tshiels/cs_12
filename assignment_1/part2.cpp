...
int main()
{
    ...
    th_mean = (a1 + b1) / 2;         //calculates theoretical mean
    
    th_var = (pow(b1 - a1, 2)) / 12;
    th_var2 = (pow(b2 - a2, 2)) / 12; //calculates theoretical variance
